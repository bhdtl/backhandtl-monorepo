...
// Reuse animation variants from original file
const fadeUpVariant = {
...
export const PlayerProfile: React.FC = () => {
  ...
  // Simulate initial meta loading (player name etc.)
  useEffect(() => {
...
// 🚀 SOTA: IMPORTIERTE NEUE INTELLIGENCE COMPONENTS
...
// ============================================================================
// 🔋 SOTA: LOAD MANAGEMENT & FATIGUE WIDGET
// ============================================================================
const LoadManagementWidget = ({ sackmannMetrics }: { sackmannMetrics: any }) => {
    ...
    // 🚀 SOTA FIX: Translated descriptions to English for consistency
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                <div className="col-span-1 md:col-span-2">
                    ...
                    <div className="h-4 bg-black/40 rounded-full overflow-hidden border border-white/5 relative">
                        ...
                        {/* 🚀 APPLE STYLE: Framer Motion Bar Fill */}
                        <motion.div 
                            initial={{ width: 0 }}
...
// ============================================================================
// 🌊 SURFACE MASTERY HUD (TRUE ELO SCALING ENGINE)
// ============================================================================
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                {surfaces.map((surf) => {
                    ...
                    if (trueElo) {
                        ...
                        else if (rating >= 4.0) textLabel = "⚠️ VULNERABLE";
                        else textLabel = "❄️ WEAKNESS";
                    }
...
// ============================================================================
// 🚀 THE NEW GOD-MODE METRICS WIDGET (RADAR CHART + APPLE CARDS)
// ============================================================================
...
// 🚀 SOTA FIX: Getrennte Text & Background Klassen zur Verhinderung unsichtbarer Schrift
...
const AdvancedQuantWidget = ({ advancedStats }: { advancedStats: any }) => {
    ...
    return (
        <motion.div variants={fadeUpVariant} className="bg-[#1a1d26] rounded-3xl p-5 md:p-6 border border-white/5 shadow-xl mb-6 relative overflow-hidden">
            ...
            {/* 🚀 APPLE STYLE: Animate Presence for Tab Swapping */}
    ...
    <div className="pb-24 bg-[#0f1115] min-h-screen relative overflow-x-hidden">
      ...
      <div className="mt-24 md:mt-28 px-4 max-w-5xl mx-auto space-y-6 md:space-y-8">
          ...
          <motion.div variants={staggerContainer} initial="hidden" animate="show" className="flex flex-col gap-6 md:gap-8">
              ...
              {/* 🚀 SOTA: THE NEW ADVANCED QUANT METRICS WIDGET */}
              ...
              {/* 🚀 SOTA: APPLE-LIKE SWIPEABLE ANALYTICS SECTION (Full Bleed Layout) */}
